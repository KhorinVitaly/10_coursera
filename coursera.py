...
if __name__ == '__main__':
    ...
    if not args.filepath:
        ...
        exit()
    try:
        with open(args.filepath, 'w') as check_filepath: pass
    ...
    if courses_url_list:
        ...
        output_courses_info_to_xlsx(args.filepath, courses_info)
        print('Courses list wrote successfully into ' + args.filepath)
